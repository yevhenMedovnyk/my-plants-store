...
const Header: FC = () => {
	...
	const handleRemoveClick = (ref: React.RefObject<HTMLInputElement>) => {
	...
	const searchInputRef = useRef<HTMLFormElement | null>(null);
	...
	const handleSearchBtnClick = (e: React.FormEvent<HTMLFormElement>) => {
		e.preventDefault();
